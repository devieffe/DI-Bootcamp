...
#Bonus: nicely line the text in columns as seen in the example above. 
...
#Add another method to the Farm class called get_short_info. This method should 
...
#Note : In English the plural form of the word “sheep” is sheep. But for the 
#purpose of the exercise, let’s say that if there is more than 1 animal, 
